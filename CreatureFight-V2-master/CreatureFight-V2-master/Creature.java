...
public class Creature extends Actor
{
    ...
    /**
     * attack is an empty method that will get overridden in subclasse
     * 
     * @param There is an integer parameter called idx (( which represents ))
     * which choice the player made when choosing an attack in a number
     * format
     * 
    ...
    /**
     * getType gets the creature type ( either the player one creature or
     * the player two creature)
     * 
     * @param None There are no parameters
     * @return type is returned. type represents what type of creature is
     * being used ( either player one creature or player two creature )
     */
